...
const { getAllUsers, getSingleUser, deleteUser, updateUser, logout, forgotPassword, getUserDetails, updatePassword, updateProfile } = require("../controllers/user.controller");
