...
const {getAllProducts,createProduct,updateProduct,getSingleProduct,deleteProduct, createProductReview, getAllReviews, deleteReview} = require("../controllers/productController");
